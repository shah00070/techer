...
public class ServiceRequestActionData {
	private int Id ;
    private String Name ;
	...
	public void setConfiguredActions(List<ConfiguredAction> configuredActions) {
		ConfiguredActions = configuredActions;
	}
	public List<ConfiguredStatu> getConfiguredStatus() {
		return ConfiguredStatus;
	}
	public void setConfiguredStatus(List<ConfiguredStatu> configuredStatus) {
		ConfiguredStatus = configuredStatus;
	}
	private boolean IsDeleted ;
    private List<ConfiguredAction> ConfiguredActions ;
    private List<ConfiguredStatu> ConfiguredStatus ;
}
