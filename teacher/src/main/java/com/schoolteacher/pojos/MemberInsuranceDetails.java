...
public class MemberInsuranceDetails {
	...
	/**
	 * @param primaryInsTitle the primaryInsTitle to set
	 */
	...
	/**
	 * @param primaryInsFirstName the primaryInsFirstName to set
	 */
	...
	/**
	 * @param primaryInsLastName the primaryInsLastName to set
	 */
	...
	/**
	 * @param primaryInsCellNumber the primaryInsCellNumber to set
	 */
	...
	/**
	 * @param primaryInsEmail the primaryInsEmail to set
	 */
	...
	/**
	 * @param tPAOrganisationName the tPAOrganisationName to set
	 */
	...
	/**
	 * @param tPACellNumber the tPACellNumber to set
	 */
	...
	/**
	 * @param tPAEmail the tPAEmail to set
	 */
