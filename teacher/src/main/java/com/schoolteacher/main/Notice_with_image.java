...
public class Notice_with_image extends BaseClass   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        globalAlert = new GlobalAlert(Notice_with_image.this);
                ...
                new Callback<MembershipAuthenticateResponse>() {
                    ...
                    public void success(MembershipAuthenticateResponse data,
                        ...
                        if (data.getData().getIsMemberinvitedSuccessfully().equals("true")) {
                            Toast.makeText(Notice_with_image.this, "Invite Friend Sent"
                    ...
                    public void failure(RetrofitError arg0) {
                        ...
                        if (arg0.isNetworkError()) {
                            if (!(Connectivity
                                    .checkConnectivity(Notice_with_image.this))) {
