...
public class FacilityProfileFragment extends Fragment implements
        OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.layout_facility_profile, container,
                false);
        ...
        profile_id = getArguments().getString("FacilityProfileId");
    ...
    public void onResume() {
        super.onResume();
        MyApplication.getInstance().trackScreenView("Facility Profile Details Fragment");
    }
    ...
    private void initiateViewElements() {
        ...
        facility_services = (TextView) view
                .findViewById(R.id.facility_services);
        facility_convenience = (TextView) view
                .findViewById(R.id.facility_convenience);
        ...
        clinics_layout = (RelativeLayout) view
        ...
        ser_container = (LinearLayout) view.findViewById(R.id.ser_container);
        conv_container = (LinearLayout) view.findViewById(R.id.conv_container);
        ser_value = (TextView) view.findViewById(R.id.ser_value);
        conv_value = (TextView) view.findViewById(R.id.conv_value);

        about_container = (RelativeLayout) view
                .findViewById(R.id.about_container);
        summary_value = (TextView) view.findViewById(R.id.summary_value);

        awards_container = (RelativeLayout) view
                .findViewById(R.id.about_container);
        awards_value = (TextView) view.findViewById(R.id.awards_value);

        deals_container = (RelativeLayout) view
                .findViewById(R.id.awards_container);
        deals_value = (TextView) view.findViewById(R.id.deals_value);
    }
...
//				gson.toJson(locationManager.getUserLocation()).toString(),pro_id.trim(),
    ...
    private void fillFacilityProfile() {
        // set profile views
        // ProfileStats stats = data.getFacilityProfile().getStats();
        // if (stats != null) {
        //
        // if (!CommonCode.isNullOrEmpty(stats.getValue())) {
        //
        // if (Integer.valueOf(stats.getValue()) > 0
        // && Integer.valueOf(stats.getValue()) > 50) {
        //
        // profile_view_count.setText(stats.getValue());
        // } else if (Integer.valueOf(stats.getValue()) > 0
        // && Integer.valueOf(stats.getValue()) < 50) {
        //
