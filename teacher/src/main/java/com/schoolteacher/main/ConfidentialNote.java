...
public class ConfidentialNote extends BaseClass   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.confi_item);
        setUpActionBar();
        ...
        globalAlert = new GlobalAlert(ConfidentialNote.this);
        ...
        clic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  int fpixels = (int) (metrics.density * dp);443 1 480
                linex=fpixels;*/

                /*
    DisplayMetrics metrics = getApplicationContext().getResources().getDisplayMetrics();
                int dp=content.getLineCount();
                int fpixels = (int) (metrics.density * dp);*/
                ...
                */
                int dp=content.getLineCount();
                int fpixels= (int) ((dp*25) * metrics.density );
//              Toast.makeText(Addnote.this, fpixels, Toast.LENGTH_SHORT).show();
                HomeActivity.persons.add(new Person(title.getText().toString(), content.getText().toString(),time,date, R.drawable.emma,"Arun Sharma"));
