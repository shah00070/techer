...
public class ServiceRequestCancelActionDialog extends DialogFragment implements
	...
	public static ServiceRequestCancelActionDialog newInstance(String title_text) {
		ServiceRequestCancelActionDialog serviceRequestCancelActionDialog = new ServiceRequestCancelActionDialog();
		// Supply num input as an argument.
		Bundle args = new Bundle();
		args.putString("title", title_text);
		serviceRequestCancelActionDialog.setArguments(args);
		return serviceRequestCancelActionDialog;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(),
				...
				Arrays.asList(getResources().getStringArray(
						R.array.cancel_status_drop_down_values)));
