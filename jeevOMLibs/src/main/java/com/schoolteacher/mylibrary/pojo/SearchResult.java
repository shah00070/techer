...
public class SearchResult implements Serializable {
	 ...
	 */
	public List<ClaimContactInfo> getContactInformations() {
	...
	public void setContactInformations(
			List<ClaimContactInfo> contactInformations) {
	...
	public String getSpecialities() {
		...
		if (Specialities != null) {
			...
			if (CommonCode.isNullOrEmpty(specialities)) {
				specialities = "Specialities: Not Available";
			}
		}
		return specialities;
	...
	private List<ClaimContactInfo> ContactInformations;
